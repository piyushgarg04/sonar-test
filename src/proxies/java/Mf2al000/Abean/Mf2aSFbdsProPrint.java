 ...
 */
public class Mf2aSFbdsProPrint  implements ActionListener, java.io.Serializable  {
 
   //  Use final String for the bean name
   public static final String BEANNAME = new String("Mf2aSFbdsProPrint");
   ...
   private Mf2aSFbdsProPrintOperation oper = null;
   ...
   public void execute()  throws PropertyVetoException {
      try  {
         if (oper == null) {
            oper = new Mf2aSFbdsProPrintOperation(this);
         ...
         oper.doMf2aSFbdsProPrintOperation();
   ...
   private class operListener implements ActionListener, java.io.Serializable  {
      private Mf2aSFbdsProPrint rP;
      operListener(Mf2aSFbdsProPrint r)  {
         rP = r;
      }
      public void actionPerformed(ActionEvent aEvent)  {
         if (Trace.isTracing(Trace.MASK_APPLICATION))
         {
            Trace.record(Trace.MASK_APPLICATION, "Mf2aSFbdsProPrint", "Listener heard that Mf2aSFbdsProPrintOperation completed with " + 
   ...
   private void notifyCompletionListeners()  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of completion of operation Mf2aSFbdsProPrint ()\n");
      }
      Vector targets;
      ...
      actionEvt = new ActionEvent(this, 0, "Completion.Mf2aSFbdsProPrint");
   ...
   private void notifyExceptionListeners(String s)  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of exception of operation Mf2aSFbdsProPrint ()\n");
      }
      Vector targets;
      ActionEvent actionEvt = null;
      String failCommand = "Exception.Mf2aSFbdsProPrint";
      synchronized (this)  {
   ...
   public void clear()  throws PropertyVetoException  {
      ...
      importView.reset();
      exportView.reset();
      importView.InRPrintGroup_MA = IntAttr.valueOf(InRPrintGroupMax);
   }

   proxy.mfl.io.MF2AS000_IA importView = proxy.mfl.io.MF2AS000_IA.getInstance();
   proxy.mfl.io.MF2AS000_OA exportView = proxy.mfl.io.MF2AS000_OA.getInstance();
   public String getInDestSicCdIshs1SharedServicesString3Tx() {
      return FixedStringAttr.valueOf(importView.InDestSicCdIshs1SharedServicesString3Tx, 3);
   }
   public void setInDestSicCdIshs1SharedServicesString3Tx(String s)
      throws PropertyVetoException {
      if (s.length() > 3) {
         throw new PropertyVetoException("InDestSicCdIshs1SharedServicesString3Tx must be <= 3 characters.",
               new PropertyChangeEvent (this, "InDestSicCdIshs1SharedServicesString3Tx", null, null));
      }
      importView.InDestSicCdIshs1SharedServicesString3Tx = FixedStringAttr.valueOf(s, (short)3);
   }
 
   public String getInPrinterCodeIshs1SharedServicesString12Tx() {
      return FixedStringAttr.valueOf(importView.InPrinterCodeIshs1SharedServicesString12Tx, 12);
   }
   public void setInPrinterCodeIshs1SharedServicesString12Tx(String s)
      throws PropertyVetoException {
      if (s.length() > 12) {
         throw new PropertyVetoException("InPrinterCodeIshs1SharedServicesString12Tx must be <= 12 characters.",
               new PropertyChangeEvent (this, "InPrinterCodeIshs1SharedServicesString12Tx", null, null));
      }
      importView.InPrinterCodeIshs1SharedServicesString12Tx = FixedStringAttr.valueOf(s, (short)12);
   }
 
   public String getInReportTypIshs1SharedServicesString8Tx() {
      return FixedStringAttr.valueOf(importView.InReportTypIshs1SharedServicesString8Tx, 8);
   }
   public void setInReportTypIshs1SharedServicesString8Tx(String s)
      throws PropertyVetoException {
      if (s.length() > 8) {
         throw new PropertyVetoException("InReportTypIshs1SharedServicesString8Tx must be <= 8 characters.",
               new PropertyChangeEvent (this, "InReportTypIshs1SharedServicesString8Tx", null, null));
      }
      importView.InReportTypIshs1SharedServicesString8Tx = FixedStringAttr.valueOf(s, (short)8);
   }
 
   public String getInFormTypIshs1SharedServicesString8Tx() {
      return FixedStringAttr.valueOf(importView.InFormTypIshs1SharedServicesString8Tx, 8);
   }
   public void setInFormTypIshs1SharedServicesString8Tx(String s)
      throws PropertyVetoException {
      if (s.length() > 8) {
         throw new PropertyVetoException("InFormTypIshs1SharedServicesString8Tx must be <= 8 characters.",
               new PropertyChangeEvent (this, "InFormTypIshs1SharedServicesString8Tx", null, null));
      }
      importView.InFormTypIshs1SharedServicesString8Tx = FixedStringAttr.valueOf(s, (short)8);
   }
 
   public String getInReprintIndIshs1SharedServicesFlagFg() {
      return FixedStringAttr.valueOf(importView.InReprintIndIshs1SharedServicesFlagFg, 1);
   }
   public void setInReprintIndIshs1SharedServicesFlagFg(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 1) {
         throw new PropertyVetoException("InReprintIndIshs1SharedServicesFlagFg must be <= 1 characters.",
               new PropertyChangeEvent (this, "InReprintIndIshs1SharedServicesFlagFg", null, null));
      }
      importView.InReprintIndIshs1SharedServicesFlagFg = FixedStringAttr.valueOf(s, (short)1);
   }
 
   public String getInIncludeProsDestinedIndIshs1SharedServicesFlagFg() {
      return FixedStringAttr.valueOf(importView.InIncludeProsDestinedIndIshs1SharedServicesFlagFg, 1);
   }
   public void setInIncludeProsDestinedIndIshs1SharedServicesFlagFg(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 1) {
         throw new PropertyVetoException("InIncludeProsDestinedIndIshs1SharedServicesFlagFg must be <= 1 characters.",
               new PropertyChangeEvent (this, "InIncludeProsDestinedIndIshs1SharedServicesFlagFg", null, null));
      }
      importView.InIncludeProsDestinedIndIshs1SharedServicesFlagFg = FixedStringAttr.valueOf(s, (short)1);
   }
 
   public String getInIncludeProsNotDestinedIndIshs1SharedServicesFlagFg() {
      return FixedStringAttr.valueOf(importView.InIncludeProsNotDestinedIndIshs1SharedServicesFlagFg, 1);
   }
   public void setInIncludeProsNotDestinedIndIshs1SharedServicesFlagFg(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 1) {
         throw new PropertyVetoException("InIncludeProsNotDestinedIndIshs1SharedServicesFlagFg must be <= 1 characters.",
               new PropertyChangeEvent (this, "InIncludeProsNotDestinedIndIshs1SharedServicesFlagFg", null, null));
      }
      importView.InIncludeProsNotDestinedIndIshs1SharedServicesFlagFg = FixedStringAttr.valueOf(s, (short)1);
   }
 
   public String getInValidateIndIshs1SharedServicesFlagFg() {
      return FixedStringAttr.valueOf(importView.InValidateIndIshs1SharedServicesFlagFg, 1);
   }
   public void setInValidateIndIshs1SharedServicesFlagFg(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 1) {
         throw new PropertyVetoException("InValidateIndIshs1SharedServicesFlagFg must be <= 1 characters.",
               new PropertyChangeEvent (this, "InValidateIndIshs1SharedServicesFlagFg", null, null));
      }
      importView.InValidateIndIshs1SharedServicesFlagFg = FixedStringAttr.valueOf(s, (short)1);
   }
 
   public String getInDomicileSicCdIshs1SharedServicesString3Tx() {
      return FixedStringAttr.valueOf(importView.InDomicileSicCdIshs1SharedServicesString3Tx, 3);
   }
   public void setInDomicileSicCdIshs1SharedServicesString3Tx(String s)
      throws PropertyVetoException {
      if (s.length() > 3) {
         throw new PropertyVetoException("InDomicileSicCdIshs1SharedServicesString3Tx must be <= 3 characters.",
               new PropertyChangeEvent (this, "InDomicileSicCdIshs1SharedServicesString3Tx", null, null));
      }
      importView.InDomicileSicCdIshs1SharedServicesString3Tx = FixedStringAttr.valueOf(s, (short)3);
   }
 
   public String getInCmanGatewaySicIopt1TrlrLoadInstLdDest() {
      return FixedStringAttr.valueOf(importView.InCmanGatewaySicIopt1TrlrLoadInstLdDest, 3);
   }
   public void setInCmanGatewaySicIopt1TrlrLoadInstLdDest(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 3) {
         throw new PropertyVetoException("InCmanGatewaySicIopt1TrlrLoadInstLdDest must be <= 3 characters.",
               new PropertyChangeEvent (this, "InCmanGatewaySicIopt1TrlrLoadInstLdDest", null, null));
      }
      importView.InCmanGatewaySicIopt1TrlrLoadInstLdDest = FixedStringAttr.valueOf(s, (short)3);
   }
 
   public String getInClosedTrlrSicGroupIopt1RefUserSicGrpGrpCd() {
      return FixedStringAttr.valueOf(importView.InClosedTrlrSicGroupIopt1RefUserSicGrpGrpCd, 8);
   }
   public void setInClosedTrlrSicGroupIopt1RefUserSicGrpGrpCd(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 8) {
         throw new PropertyVetoException("InClosedTrlrSicGroupIopt1RefUserSicGrpGrpCd must be <= 8 characters.",
               new PropertyChangeEvent (this, "InClosedTrlrSicGroupIopt1RefUserSicGrpGrpCd", null, null));
      }
      importView.InClosedTrlrSicGroupIopt1RefUserSicGrpGrpCd = FixedStringAttr.valueOf(s, (short)8);
   }
 
   public String getInIncludeClosedTrlrFlagIshs1SharedServicesFlagFg() {
      return FixedStringAttr.valueOf(importView.InIncludeClosedTrlrFlagIshs1SharedServicesFlagFg, 1);
   }
   public void setInIncludeClosedTrlrFlagIshs1SharedServicesFlagFg(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 1) {
         throw new PropertyVetoException("InIncludeClosedTrlrFlagIshs1SharedServicesFlagFg must be <= 1 characters.",
               new PropertyChangeEvent (this, "InIncludeClosedTrlrFlagIshs1SharedServicesFlagFg", null, null));
      }
      importView.InIncludeClosedTrlrFlagIshs1SharedServicesFlagFg = FixedStringAttr.valueOf(s, (short)1);
   }
 
   public final int InRPrintGroupMax = 500;
   public short getInRPrintGroupCount() {
      return (short)(importView.InRPrintGroup_MA);
   };
 
   public void setInRPrintGroupCount(short s) throws PropertyVetoException {
      if (s < 0 || s > InRPrintGroupMax) {
         throw new PropertyVetoException("InRPrintGroupCount value is not a valid value. (0 to 500)",
               new PropertyChangeEvent (this, "InRPrintGroupCount", null, null));
      } else {
         importView.InRPrintGroup_MA = IntAttr.valueOf((int)s);
      }
   }
 
   public String getInRPrintRequestKeyIshs1SharedServicesString20Tx(int index) throws ArrayIndexOutOfBoundsException {
      if (499 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 499, not: " + index);
      }
      return FixedStringAttr.valueOf(importView.InRPrintRequestKeyIshs1SharedServicesString20Tx[index], 20);
   }
   public void setInRPrintRequestKeyIshs1SharedServicesString20Tx(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (499 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 499, not: " + index);
      }
      if (s.length() > 20) {
         throw new PropertyVetoException("InRPrintRequestKeyIshs1SharedServicesString20Tx must be <= 20 characters.",
               new PropertyChangeEvent (this, "InRPrintRequestKeyIshs1SharedServicesString20Tx", null, null));
      }
      importView.InRPrintRequestKeyIshs1SharedServicesString20Tx[index] = FixedStringAttr.valueOf(s, (short)20);
   }
   ...
   public String getOutFormTypeLoadedIrtr1PrinterFormTyp() {
      return FixedStringAttr.valueOf(exportView.OutFormTypeLoadedIrtr1PrinterFormTyp, 8);
   }
 
   public String getOutValueInErrorIshs1SharedServicesString20Tx() {
      return FixedStringAttr.valueOf(exportView.OutValueInErrorIshs1SharedServicesString20Tx, 20);
   }
   ...
   public int getOutErrorIshs1SharedServicesSubscriptNb() {
      return exportView.OutErrorIshs1SharedServicesSubscriptNb;
   }

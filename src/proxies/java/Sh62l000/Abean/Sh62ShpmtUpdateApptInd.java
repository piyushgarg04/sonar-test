 ...
 */
public class Sh62ShpmtUpdateApptInd  implements ActionListener, java.io.Serializable  {
 
   //  Use final String for the bean name
   public static final String BEANNAME = new String("Sh62ShpmtUpdateApptInd");
   ...
   private Sh62ShpmtUpdateApptIndOperation oper = null;
   ...
   public void execute()  throws PropertyVetoException {
      try  {
         if (oper == null) {
            oper = new Sh62ShpmtUpdateApptIndOperation(this);
         ...
         oper.doSh62ShpmtUpdateApptIndOperation();
   ...
   private class operListener implements ActionListener, java.io.Serializable  {
      private Sh62ShpmtUpdateApptInd rP;
      operListener(Sh62ShpmtUpdateApptInd r)  {
         rP = r;
      }
      public void actionPerformed(ActionEvent aEvent)  {
         if (Trace.isTracing(Trace.MASK_APPLICATION))
         {
            Trace.record(Trace.MASK_APPLICATION, "Sh62ShpmtUpdateApptInd", "Listener heard that Sh62ShpmtUpdateApptIndOperation completed with " + 
   ...
   private void notifyCompletionListeners()  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of completion of operation Sh62ShpmtUpdateApptInd ()\n");
      }
      Vector targets;
      ...
      actionEvt = new ActionEvent(this, 0, "Completion.Sh62ShpmtUpdateApptInd");
   ...
   private void notifyExceptionListeners(String s)  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of exception of operation Sh62ShpmtUpdateApptInd ()\n");
      }
      Vector targets;
      ActionEvent actionEvt = null;
      String failCommand = "Exception.Sh62ShpmtUpdateApptInd";
      synchronized (this)  {
   ...
   proxy.shm.io.SH62S000_IA importView = proxy.shm.io.SH62S000_IA.getInstance();
   proxy.shm.io.SH62S000_OA exportView = proxy.shm.io.SH62S000_OA.getInstance();
   ...
   public String getInIshm1ShipmentApptRqrdInd() {
      return FixedStringAttr.valueOf(importView.InIshm1ShipmentApptRqrdInd, 1);
   }
   public void setInIshm1ShipmentApptRqrdInd(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 1) {
         throw new PropertyVetoException("InIshm1ShipmentApptRqrdInd must be <= 1 characters.",
               new PropertyChangeEvent (this, "InIshm1ShipmentApptRqrdInd", null, null));
      }
      importView.InIshm1ShipmentApptRqrdInd = FixedStringAttr.valueOf(s, (short)1);
   }

...
public class LoadValuesToUpdateManRateAcSvcImpl extends AbstractAcSvc implements LoadValuesToUpdate<ShmAcSvc, ShmAcSvc> {
	...
	private static void setValues(ShmAcSvc shmAcSvc, ShmAcSvc acSvcFound) {
		...
		if (Objects.nonNull(acSvcFound.getPpdPct())) {
			shmAcSvc.setPpdPct(acSvcFound.getPpdPct());
		}
